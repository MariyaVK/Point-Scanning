...
public class PolarAngleComparator implements Comparator<Point> {
	 ...
	 *         following two conditions holds: a) the polar angle of p1 w.r.t.
	 *         referencePoint is less than that of p2. b) the two points have
	 *         the same polar angle but p1 is closer to referencePoint * than
	 *         p2. * * 1 otherwise. *
	 */
	 ...
	 * functions. All polar angles are within the range [0, 2 * pi). Ought to be
	 * private but made public for testing purpose.
	 * 
	 * @param p1
	 * @param p2
	 * @return 0 if one of the following two situations happens: * * a) p1 and
	 *         p2 are the same point (this case is checked already if the *
	 *         method is called within compare()). b) none is equal to
	 *         referencePoint, but the vectors p1 - referencePoint and * p2 -
	 *         referencePoint have a zero cross product and a positive dot
	 *         product. * * -1 otherwise, if p1 equals referencePoint; *
	 *         otherwise, if p2 is not equal to referencePoint and one of the
	 *         following situations * below happens: * * 1) p1.y <
	 *         referencePoint.y and p2.y < referencePoint.y, and the cross
	 *         product of * p1 - referencePoint and p2 - referencePoint is
	 *         positive. * * 2) p1.y == referencePoint.y and one of the
	 *         following three situations happens: * * a) p2.y <
	 *         referencePoint.y * b) p2.y == referencePoint.y and p1.x >
	 *         referencePoint.x and p2.x < referencePoint.x * c) p2.y >
	 *         referencePoint.y and p1.x > referencePoint.x * * 3) p1.y >
	 *         referencePoint.y and one of the following three situations
	 *         happens: * * a) p2.y > referencePoint.y and the cross product of
	 *         p1 - referencePoint * and p2 - referencePoint is positive. * b)
	 *         p2.y == referencePoint.y and p2.x < referencePoint.x. * c) p2.y <
	 *         referencePoint.y * * 1 otherwise.
	 */
	 ...
	 *         closer to referencePoint than p2 1 otherwise
	 */
